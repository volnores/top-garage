          ...
          >
            ...
            <div className="flex flex-col  md:flex-row md:space-x-4 gap-4 mb-4 relative z-10">
              <button
                ...
                className="bg-blue-600 min-w-60 text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-blue-700"
              >
                Записаться в сервис
              </button>
              <button
                onClick={handleNavigateService}
                className="bg-sky-500 min-w-60 text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-sky-600"
              >
                Все услуги
              </button>
            </div>
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:space-x-4 gap-4 mb-4 relative z-10">
              ...
              <button
                onClick={scrollToContactForm}
                className="bg-green-600 min-w-60 text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-green-700"
              >
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:space-x-4 gap-4 mb-4 relative z-10">
              ...
              <button
                onClick={scrollToContactForm}
                className="bg-red-600 min-w-60 text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-red-700"
              >
                Записаться сейчас
              </button>
            </div>
