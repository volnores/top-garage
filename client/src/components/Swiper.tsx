      ...
      >
        ...
        <SwiperSlide>
          ...
          >
            ...
            <p className="flex relative z-10 text-lg">
              Профессиональный подход, надежность гарантирована! <br /> Ваше
              авто — это наша работа, наша забота и наша гордость.
            </p>

            <div className="flex flex-col  md:flex-row md:space-x-4 gap-4 mb-4 relative z-10">
              <button
                onClick={scrollToContactForm}
                className="bg-blue-600 min-w-60 font-medium text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-blue-700"
              >
                Записаться в сервис
              </button>
              <button
                onClick={handleNavigateService}
                className="bg-sky-500 min-w-60 font-medium text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-sky-600"
              >
                Все услуги
              </button>
            </div>
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:space-x-4 gap-4 mb-4 relative z-10">
              ...
              <button
                onClick={scrollToContactForm}
                className="bg-green-600 min-w-60 font-medium text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-green-700"
              >
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="absolute inset-0 bg-black opacity-60 rounded-lg"></div>
            <p className="text-4xl mb-4 font-bold text-customColor relative z-10">
              <span className="font-bold text-yellow-400">Скидки</span> для
              новых клиентов!
            </p>
            <p className="flex relative z-10 text-lg">
              Получите 10% скидки на первый визит. <br /> Спешите
              воспользоваться уникальными предложениями!
            </p>
            ...
            <div className="flex flex-col md:flex-row md:space-x-4 gap-4 mb-4 relative z-10">
              ...
              <button
                onClick={scrollToContactForm}
                className="bg-red-600 min-w-60 font-medium text-white py-3 px-4 rounded-md transition duration-300 transform hover:bg-red-700"
              >
                Записаться сейчас
              </button>
            </div>
