      ...
      <Swiper
        ...
        <SwiperSlide>
          <div
            ...
            <p className="flex flex-col relative z-10 text-lg">
              <p className="text-2xl mb-8 font-bold ">Обслуживаем по предварительной записи!</p>
              Профессиональный подход, надежность гарантирована! <br />
            </p>
